...
<body>
    ...
    <form class="form" id="formportfolio" autocomplete="off" runat="server">
        ...
        <!-- Hobbies -->
        <div class="card bg-transparent border-0" id="Hobbies" runat="server">
            <div class="row w-100 py-5">
                <div class="col py-5 w-100" style="padding-left: 60px;">
                ...
                <div class="col">
                    <div class="row px-0">
                        <div class="col-md-3 py-2" style="text-align:center;">
                            <label class="labelHeader" style="font-size:24px;"><i class="fas fa-map-marker-alt"></i></label>
                            <label class="labelHeader" style="font-size:24px;">ADDRESS</label>
                            <label class="label" style="font-size:18px;">Budapest, Hungary</label>
                        </div>
                        <div class="col-md-3 py-2" style="text-align:center;">
                            <label class="labelHeader" style="font-size:24px;"><i class="fas fa-mobile"></i></label>
                            <label class="labelHeader" style="font-size:24px;">TELEPHONE</label>
                            <label class="label" style="font-size:18px;">+36 30 446 5894</label>
                        </div>
                        <div class="col-md-3 py-2" style="text-align:center;">
                            <label class="labelHeader" style="font-size:24px;"><i class="fas fa-envelope"></i></label>
                            <label class="labelHeader" style="font-size:24px;">EMAIL</label>
